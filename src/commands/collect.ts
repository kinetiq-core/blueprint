...
export async function collect(flags: Record<string, string | boolean>): Promise<void> {
...
function copyFiltered(srcDir: string, destDir: string, filter: (name: string) => boolean): number {
